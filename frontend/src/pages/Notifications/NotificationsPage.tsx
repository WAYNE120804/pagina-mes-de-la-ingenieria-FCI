...
const NotificationsPage = () => {
  ...
  async function submitCommunication(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setTitle('');
      setBody('');
      setNotice('Mensaje enviado. Si SMTP no está configurado, queda registrado como no enviado.');
      await loadData();
    } catch {
      ...
      <div className="space-y-6 px-6 py-6">
        <div className="grid gap-6 xl:grid-cols-[420px_1fr]">
          <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
            <h3 className="text-base font-semibold text-slate-950">Nueva comunicación</h3>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-[900px] table-fixed divide-y divide-slate-200 text-sm">
                <thead className="theme-table-head">
                  <tr>
                    <th className="w-[260px] px-5 py-3 text-left">Título</th>
